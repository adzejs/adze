...
function cache(def, args) {
  if (Object(_shed__WEBPACK_IMPORTED_MODULE_1__["storeExists"])(_global__WEBPACK_IMPORTED_MODULE_0__["env"].$shed)) {
    _global__WEBPACK_IMPORTED_MODULE_0__["env"].$shed.addToCache(this, def, args);
  }
}
/**
...
function fireListeners(def, args) {
  if (Object(_shed__WEBPACK_IMPORTED_MODULE_1__["storeExists"])(_global__WEBPACK_IMPORTED_MODULE_0__["env"].$shed)) {
    _global__WEBPACK_IMPORTED_MODULE_0__["env"].$shed.fireListeners(this, def, args);
  }
}
...
function all(ctxt, bundle = []) {
  bundle.forEach(log => {
    var _log$terminatingMetho, _log$args;

    const method_key = (_log$terminatingMetho = log.terminatingMethod) !== null && _log$terminatingMetho !== void 0 ? _log$terminatingMetho : '';
    const args = (_log$args = log.args) !== null && _log$args !== void 0 ? _log$args : [];
...
function isStandard(cfg, key) {
  var _cfg$log_levels;

  return Object.keys((_cfg$log_levels = cfg === null || cfg === void 0 ? void 0 : cfg.log_levels) !== null && _cfg$log_levels !== void 0 ? _cfg$log_levels : {}).includes(key);
}
...
function printLog(def, base_style, _args) {
  const render = makeRender(this, def.method, def, base_style, _args);
  const [method, [leader, style, meta, args]] = render; // Must check the return value of meta otherwise Firefox prints "empty string"...
...
function printGroup(def, base_style, _args) {
...
function printGroupCollapsed(def, base_style, _args) {
...
function makeRender(ctxt, method, def, base_style, args) {
...
function printNode(def, base_style, _args) {
  const render = makeRender(this, def.method, def, base_style, _args);
  const [method, [leader, style, meta, args]] = render;
  console[method](leader, style, meta, ...args);
  return render;
}
function printNodeGroup(def, base_style, _args) {
  const render = makeRender(this, 'group', def, base_style, _args);
  const [_, [leader, style, __, args]] = render;
  console.group(leader, style, typeof args[0] === "string" ? args[0] : undefined);
  return render;
}
function printNodeGroupCollapsed(def, base_style, _args) {
  const render = makeRender(this, 'groupCollapsed', def, base_style, _args);
  const [_, [leader, style, __, args]] = render;
  console.groupCollapsed(leader, style, typeof args[0] === "string" ? args[0] : undefined);
  return render;
...
/*!********************************!*\
  !*** ./src/printers/shared.ts ***!
  \********************************/
/*! exports provided: print, printGroupEnd, printTable, printDir, printDirxml, printTrace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _defaults__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_defaults */ "./src/_defaults/index.ts");
...
function executionPipeline(log, def, args) {
  // Save the terminating method key and args for recall purposes
  log.terminatingMethod = def.levelName;
  log.args = args; // Apply modifiers in the proper order

  log.modifierQueue.forEach(func => func());
  const render = log.print(def, _defaults__WEBPACK_IMPORTED_MODULE_1__["defaults"].base_style, args);
  log.cache(def, args);
  log.fireListeners(def, args);
  return {
    log,
    render
  };
...
function notTestEnv() {
  if (_global__WEBPACK_IMPORTED_MODULE_2__["isBrowser"]) {
    return true;
  }

  return (_global__WEBPACK_IMPORTED_MODULE_2__["env"] === null || _global__WEBPACK_IMPORTED_MODULE_2__["env"] === void 0 ? void 0 : _global__WEBPACK_IMPORTED_MODULE_2__["env"].ADZE_ENV) !== 'test';
}
