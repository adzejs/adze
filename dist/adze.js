...
var Shed = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Shed, [{
    ...
    key: "fireListeners",
    value: function fireListeners(render, log) {
...
function executionPipeline(log, cfg, def, args) {
  if (def && Object(_conditions__WEBPACK_IMPORTED_MODULE_2__["allowed"])(cfg, def)) {
    ...
    if (Object(_conditions__WEBPACK_IMPORTED_MODULE_2__["evalPasses"])(log)) {
      ...
      if (globally_allowed) {
        // Render the log
        var render = Object(_printers__WEBPACK_IMPORTED_MODULE_1__["print"])(final_log, def, args); // TODO: print doesn't need to accept def and args as they're on final_log
        // Fire log events

        store(final_log);
        fireListeners(render, final_log); // Return the terminated log object for testing purposes
...
function fireListeners(render, log) {
  var shed = _global__WEBPACK_IMPORTED_MODULE_5__["env"].$shed;
