...
function fTime(log, use_emoji) {
  var _ref2, _log$timeNowVal, _log$labelVal, _env$$shed, _env$$shed$cfg, _env$$shed$cfg$global;
  ...
  return label_txt !== '' ? "(".concat(((_env$$shed = _global__WEBPACK_IMPORTED_MODULE_3__["env"].$shed) === null || _env$$shed === void 0 ? void 0 : (_env$$shed$cfg = _env$$shed.cfg) === null || _env$$shed$cfg === void 0 ? void 0 : (_env$$shed$cfg$global = _env$$shed$cfg.global_cfg) === null || _env$$shed$cfg$global === void 0 ? void 0 : _env$$shed$cfg$global.use_emoji) || use_emoji ? '⏱' : '').concat(label_txt, ") ") : '';
}
...
var Shed = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Shed, [{
    ...
    get: function get() {
      ...
      return (_this$cfg4 = this.cfg) === null || _this$cfg4 === void 0 ? void 0 : _this$cfg4.filters.hideAll;
    }
    /**
