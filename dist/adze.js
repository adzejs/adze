...
var Shed = /*#__PURE__*/function () {
  ...
  function Shed(config) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "mem_cache", []);
    ...
    var global_cfg = config !== null && config !== void 0 && config.global_cfg ? defaultsDeep(config.global_cfg, _defaults__WEBPACK_IMPORTED_MODULE_4__["defaults"]) : null;

    var cfg_global_defaults = _objectSpread(_objectSpread({}, config), {}, {
      global_cfg: global_cfg
    });

    var cfg_defaults = defaultsDeep(cfg_global_defaults, _defaults__WEBPACK_IMPORTED_MODULE_4__["shed_defaults"]);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Shed, [{
    ...
    value: function parseFilterLevels(cfg) {
      ...
      if (this.filterIsSet(cfg, 'include', 'level') && (_new_cfg$filters$leve = new_cfg.filters.level) !== null && _new_cfg$filters$leve !== void 0 && _new_cfg$filters$leve.include) {
        new_cfg.filters.level.include = Object(_util__WEBPACK_IMPORTED_MODULE_5__["formatLevels"])(new_cfg.global_cfg, new_cfg.filters.level.include);
      }
      ...
      if (this.filterIsSet(cfg, 'exclude', 'level') && (_new_cfg$filters$leve2 = new_cfg.filters.level) !== null && _new_cfg$filters$leve2 !== void 0 && _new_cfg$filters$leve2.exclude) {
        new_cfg.filters.level.exclude = Object(_util__WEBPACK_IMPORTED_MODULE_5__["formatLevels"])(new_cfg.global_cfg, new_cfg.filters.level.exclude);
      }
    ...
    value: function getCollection(levels) {
      var lvls = Object(_util__WEBPACK_IMPORTED_MODULE_5__["formatLevels"])(this.cfg.global_cfg, levels);
    ...
    value: function namespaceAllowed(log) {
      ...
      return this.filterAllowed('namespace', function (filter, func) {
        ...
        if (target) {
          if (Object(_util__WEBPACK_IMPORTED_MODULE_5__["isString"])(target)) {
    ...
    get: function get() {
      if (this.cfg.cache_location === "localStorage") {
        var _diskCache$getItem;

        return (_diskCache$getItem = Object(_util__WEBPACK_IMPORTED_MODULE_5__["diskCache"])().getItem('$ADZE_SHED_CACHE')) !== null && _diskCache$getItem !== void 0 ? _diskCache$getItem : [];
      }
    ...
    set: function set(logs) {
      if (this.cfg.cache_location === "localStorage") {
        Object(_util__WEBPACK_IMPORTED_MODULE_5__["diskCache"])().setItem('$ADZE_SHED_CACHE', logs);
      }
    ...
    set: function set(cfg) {
      var defaulted = cfg ? defaultsDeep(cfg, _defaults__WEBPACK_IMPORTED_MODULE_4__["defaults"]) : cfg;
...
/*!***************************!*\
  !*** ./src/util/index.ts ***!
  \***************************/
/*! exports provided: initialCaps, mutateProps, timestamp, getSearchParams, formatLevels, isRange, getMaxLevel, parseRange, levelsFromConfig, createArrayOfNumbers, isString, isArray, isDefined, diskCache */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "diskCache", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["diskCache"]; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "diskCache", function() { return diskCache; });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
...
function getSearchParams() {
  if (Object(_global__WEBPACK_IMPORTED_MODULE_3__["envIsWindow"])(_global__WEBPACK_IMPORTED_MODULE_3__["env"])) {
    return new URLSearchParams(_global__WEBPACK_IMPORTED_MODULE_3__["env"].document.location.search.substring(1));
  }
}
/**
...
function formatLevels(cfg, levels) {
  if (isString(levels)) {
    ...
    if (isRange(levels)) {
      return createArrayOfNumbers.apply(void 0, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(parseRange(levels)));
    }
...
function isRange(val) {
  ...
  var _vals = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default()(vals, 2),
      low = _vals[0],
      high = _vals[1];
...
function getMaxLevel(cfg) {
  ...
  return Math.max.apply(Math, [8].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(levelsFromConfig((_cfg$custom_levels = cfg === null || cfg === void 0 ? void 0 : cfg.custom_levels) !== null && _cfg$custom_levels !== void 0 ? _cfg$custom_levels : {}))));
}
/**
...
function parseRange(range) {
  var _range$split = range.split('-'),
      _range$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default()(_range$split, 2),
      low = _range$split2[0],
...
function diskCache() {
  return {
    ...
    setItem: function setItem(key, val) {
      var store_str = JSON.stringify(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, key, val));
