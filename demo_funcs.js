...
export default function runDemo(adze) {
  defaultTerminators(adze);
  // defaultLevels(lib);
...
function defaultTerminators(adze) {
...
// function defaultLevelsWithGlobalOverride({
//   adze,
//   createGlobalStore,
//   removeGlobalStore,
// }) {
...
//   });
//   adze().verbose(
//     "This is a verbose with styling overrides from the GlobalStore.",
//   );
//   removeGlobalStore();
// }
...
//     .ns("foo", "bar")
//     .ns("baz")
//     .log("Multiple calls to namespace are additive.");
...
//     adze()
//       .test(data.isSilent === true)
//       .success("The log is silent!", data);
//     adze()
//       .test(render !== null)
//       .success("Render is not null!", render);
//     adze()
//       .test(printed === false)
//       .success("The log did not print!", printed);
//   });
...
//     .info("Testing multiple namespaces using rest parameters.");
//   adze()
//     .ns("foo", "bar", "baz")
//     .info(
//       "Testing multiple namespaces using rest parameters with the ns() alias.",
//     );
// }
...
//   adze({ unstyled: true })
//     .label("timestamped")
//     .timestamp.log("I have a timestamp and no styles.");
// }
...
//   adze({ machineReadable: true, captureStacktrace: true }).log(
//     "Testing the global captureStacktrace configuration.",
//   );
// }
