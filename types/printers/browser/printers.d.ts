 ...
 */
export declare function printLog(log: Log, def: LogLevelDefinition, use_emoji: boolean, args: any[]): LogRender;
/**
 * The method for printing group logs to the browser console.
 */
export declare function printGroup(log: Log, def: LogLevelDefinition, use_emoji: boolean, args: any[]): LogRender;
/**
 * The method for printing collapsed group logs to the browser console.
 */
export declare function printGroupCollapsed(log: Log, def: LogLevelDefinition, use_emoji: boolean, args: any[]): LogRender;
/**
 ...
 */
export declare function fMeta(log: Log, use_emoji: boolean): string;
