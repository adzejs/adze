<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/factories.html#bundle">bundle</RouteLink> factory. These log
      instances have a getter that allows you to access the log bundle.
    </p>
    <p>
      Collections are typically used in conjunction with filter functions like
      <RouteLink to="/getting-started/filtering-and-utility-functions.html#filternamespace"
        >filterNamespace</RouteLink
      >,
      <RouteLink to="/getting-started/filtering-and-utility-functions.html#filterlabel"
        >filterLabel</RouteLink
      >,
      <RouteLink to="/getting-started/filtering-and-utility-functions.html#filterlevel"
        >filterLevel</RouteLink
      >, and
      <RouteLink to="/getting-started/filtering-and-utility-functions.html#filtercollection"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      globally tracked <RouteLink to="/getting-started/modifiers.html#count">counters</RouteLink>,
      <RouteLink to="/getting-started/modifiers.html#time">timers</RouteLink>, and
      <RouteLink to="/getting-started/other-terminators.html#thread">MDC context</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/using-globalstore.html#addlistener">addListener</RouteLink>,
      <RouteLink to="/getting-started/filtering-and-utility-functions.html#filterlevel"
        >filterLevel</RouteLink
      >, or within the
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/getting-started/examples/log-render-example.png"
        alt="log render example output"
      />
    </p>
    <p>
      <img
        src="@source/getting-started/examples/log-render-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/getting-started/using-globalstore.html#addlistener">log listener</RouteLink>
      on a <RouteLink to="/getting-started/globalstore-concepts.html">GlobalStore</RouteLink> is
      fired, the callback function will be invoked with two parameters; the
      <strong>log data object</strong> and a
      <RouteLink to="/getting-started/adze-concepts.html#logrender">log render</RouteLink>.
    </p>
    <p>
      A log data object can be manually retrieved from a log instance using the
      <RouteLink to="/getting-started/getters-and-setters.html#data">data getter</RouteLink>.
    </p>
    <p>
      A log data object can also be used to create a clone of a log by
      <RouteLink to="/getting-started/getters-and-setters.html#hydrate">hydrating</RouteLink> a new
      log instance from the log data object.
    </p>
    <p>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><RouteLink to="/getting-started/modifiers.html#assert">assert</RouteLink></td>
        </tr>
        <tr>
          <td>cfg</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/getting-started/mapped-diagnostic-context.html">MDC</RouteLink></td>
        </tr>
        <tr>
          <td>definition</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/getting-started/modifiers.html#test">test</RouteLink></td>
        </tr>
        <tr>
          <td>isSilent</td>
          <td>Boolean value indicating if the log should execute silently.</td>
          <td><RouteLink to="/getting-started/modifiers.html#silent">silent</RouteLink></td>
        </tr>
        <tr>
          <td>printed</td>
          <td>
        ...
        <tr>
          ...
          <td><RouteLink to="/getting-started/modifiers.html#timestamp">timestamp</RouteLink></td>
        </tr>
        <tr>
          <td>label</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/getting-started/modifiers.html#meta">meta</RouteLink></td>
        </tr>
        <tr>
          <td>modifierQueue</td>
          <td>
        ...
        <tr>
          ...
          <td>
            <RouteLink to="/getting-started/modifiers.html#namespace-ns">namespace / ns</RouteLink>
          </td>
        </tr>
        <tr>
          <td>stacktrace</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/getting-started/modifiers.html#timenow">timeNow</RouteLink></td>
        </tr>
        <tr>
          <td>timestamp</td>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/getting-started/examples/log-data-example.png"
        alt="log data example output"
      />
    </p>
    <p>
      <img
        src="@source/getting-started/examples/log-data-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/getting-started/filtering-and-utility-functions.html#render"
        >render</RouteLink
      >
      a log using a log render:
    </p>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/filtering-and-utility-functions.html#render">render</RouteLink
      >.
    </p>
    <div
      class="language-javascript line-numbers-mode"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/other-terminators.html#clear-clr">clear</RouteLink>). A
      terminated log object consists of three parts, the <strong>Log Instance</strong>, the
    ...
    <p>
      ...
      <RouteLink to="/getting-started/factories.html#bundle">bundled</RouteLink>.
    </p>
    <blockquote>
