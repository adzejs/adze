<template><div><h1 id="log-threading-mdc" tabindex="-1"><a class="header-anchor" href="#log-threading-mdc"><span>Log Threading (MDC)</span></a></h1>
...
as Adze calls it, <strong>Log Threading</strong>. Think of a log thread like a thread on a message board or
...
<p><img src="@source/getting-started/examples/log-threading/thread-example-1.png" alt="Example of a single log dumping out values from multiple scopes"></p>
<hr>
