<template>
  <div>
    ...
    <p>
      ...
      as <RouteLink to="/getting-started/globalstore-concepts.html">GlobalStore</RouteLink>,
      <RouteLink to="/getting-started/modifiers.html#label">label</RouteLink>, and
      <RouteLink to="/getting-started/other-terminators.html#thread">thread</RouteLink>. We can also
      print our context using
      <RouteLink to="/getting-started/modifiers.html#dump">dump</RouteLink> or clear our context
      using <RouteLink to="/getting-started/modifiers.html#close">close</RouteLink>.
    </p>
