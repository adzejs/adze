...
<p><img src="@source/getting-started/examples/introduction/adze.jpg" alt="A drawing of a man using an adze to shape a log"></p>
...
<p><img src="@source/getting-started/examples/introduction/demo.jpg" alt="Preview of Adze logs"></p>
<blockquote>
...
<p><img src="@source/getting-started/examples/introduction/api_example_output_1.png" alt="Adze log example"></p>
...
<p><img src="@source/getting-started/examples/introduction/api_example_output_2.png" alt="Example of Adze child logger"></p>
</div></template>
