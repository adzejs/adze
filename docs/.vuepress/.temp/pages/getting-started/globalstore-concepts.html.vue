<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/adze-concepts.html#lifecycle">Lifecycle Diagram</RouteLink>.
    </p>
    <p>
      GlobalStore is also a dependency to take advantage of some log features such as
      <RouteLink to="/getting-started/modifiers.html#label">labels</RouteLink>,
      <RouteLink to="/getting-started/modifiers.html#count">counters</RouteLink>, and
      <RouteLink to="/getting-started/modifiers.html#time">timers</RouteLink>. Without the presence
    ...
    <p>
      <img
        src="@source/getting-started/assets/large-project.svg"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/data.html#log-data">log data object</RouteLink> and the
      <RouteLink to="/getting-started/data.html#log-render">log render</RouteLink>. With these data
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/data.html#collection">collection</RouteLink> of logs.
    </p>
    <p>
