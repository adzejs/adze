<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/modifiers.html">modifiers</RouteLink> which can be terminated
      by whichever severity level you prefer.
    </p>
    <p>
    ...
    <p>
      ...
      library only offers
      <RouteLink to="/getting-started/globalstore-concepts.html#listeners">listeners</RouteLink> as
      a way of collecting log data. With access to the listeners the end user can harvest the
      desired data and do with it as they please. However, we also understand it's nice to have an
      out-of-the-box solution for transports. Over time we hope to provide some secondary packages
      that can be installed along side of Adze to provide some simple transport options.
    </p>
    <h2 id="lifecycle" tabindex="-1">
      <a class="header-anchor" href="#lifecycle"><span>Lifecycle</span></a>
    </h2>
    <p>
      Let's take a look under the hood to see how the Adze architecture enables its API and see when
      the various middleware hooks are called.
    </p>
    <p>
      <img
        src="@source/getting-started/assets/basic-architecture.svg"
        alt="Lifecycle Diagram of Adze Logs"
      />
    </p>
    ...
    <ul>
      <li>
        <RouteLink to="/getting-started/adze-class.html">Adze Class</RouteLink>
        <ul>
          <li>This is a function that generates a log instance and returns it.</li>
        </ul>
      </li>
      <li>
        <RouteLink to="/getting-started/modifiers.html">Modifiers</RouteLink>
        <ul>
          <li>These log methods modify the instance and then return it.</li>
        </ul>
      </li>
      <li>
        <RouteLink to="/getting-started/default-terminators.html">Terminator</RouteLink>
        <ul>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/factories.html#adze"><code v-pre>adze()</code></RouteLink> out
      of the box. This function is a
      <RouteLink to="/getting-started/factories.html">factory</RouteLink> that creates a new Adze
      instance. Most of the time when interacting with this library you will either use this factory
      directly or assign it to a variable after calling
      <RouteLink to="/getting-started/factories.html#seal">seal</RouteLink>, but we'll come back to
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/getting-started/examples/modifier-example.png"
    ...
    <p>
      ...
      with
      <RouteLink to="/getting-started/default-terminators.html#log"
        ><code v-pre>log()</code></RouteLink
      >. The log method is one of the eight
      <RouteLink to="/getting-started/default-terminators.html">default log terminators</RouteLink>.
      The library also comes with
      <RouteLink to="/getting-started/other-terminators.html">other special terminators</RouteLink>
      like <RouteLink to="/getting-started/other-terminators.html#custom">custom</RouteLink>. A log
      method is considered a terminator when it ends your log chain and returns a
    ...
    <p>
      ...
      <RouteLink to="/getting-started/factories.html#seal">seal factory</RouteLink>. When your
      configuration is sealed a new log factory is returned. All subsequent logs generated from that
      factory will inherit the configuration you sealed.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/getting-started/examples/common-usage-example.png"
        alt="common usage example with seal"
      />
    </p>
    <p>
      <img
        src="@source/getting-started/examples/common-usage-terminal-example.png"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/getting-started/globalstore-concepts.html">GlobalStore</RouteLink> for
      <RouteLink to="/getting-started/globalstore-concepts.html#listeners">listening</RouteLink> to
      our logs and we'll configure our adze factory with some
      <RouteLink to="/config/#filters">filters</RouteLink> that we'll
      <RouteLink to="/getting-started/modifiers.html#seal">seal</RouteLink> into a new factory named
      <code v-pre>log</code>.
    </p>
    <div
      class="language-javascript line-numbers-mode"
