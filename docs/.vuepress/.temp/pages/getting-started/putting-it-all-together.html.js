...
const data = JSON.parse(
  '{"path":"/getting-started/putting-it-all-together.html","title":"Putting It All Together","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Production Example","slug":"production-example","link":"#production-example","children":[]}],"git":{"updatedTime":1724360151000,"contributors":[{"name":"Andrew Stacy","email":"astacy@stratacache.com","commits":1}]},"filePathRelative":"getting-started/putting-it-all-together.md"}'
);
export { comp, data };
