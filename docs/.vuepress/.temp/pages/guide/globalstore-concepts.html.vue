<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/guide/adze-concepts.html#lifecycle">Lifecycle Diagram</RouteLink>.
    </p>
    <p>
      GlobalStore is also a dependency to take advantage of some log features such as
      <RouteLink to="/guide/modifiers.html#label">labels</RouteLink>,
      <RouteLink to="/guide/modifiers.html#count">counters</RouteLink>, and
      <RouteLink to="/guide/modifiers.html#time">timers</RouteLink>. Without the presence of a
      GlobalStore, these log modifiers either do not function or their functionality is stunted.
    </p>
    <p>
    ...
    <p>
      <img
        src="@source/guide/assets/large-project.svg"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/guide/data.html#log-data">log data object</RouteLink> and the
      <RouteLink to="/guide/data.html#log-render">log render</RouteLink>. With these data objects
      Adze enables the user to do with the data as they wish. You could write a log to a file. You
      could send some data about the log to a REST API. It's up to you.
    </p>
    <p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/guide/filtering-and-utility-functions.html">filter functions</RouteLink> out
      of the box and that you can use to operate on a
      <RouteLink to="/guide/data.html#collection">collection</RouteLink> of logs.
    </p>
    <p>
