<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/guide/advanced.html#collections">Collection</RouteLink> of logs that you would
      like to filter down to a specific subset. Adze provides you with some filtering functions out
      of the box to help with this. Adze also provides a couple utility functions that are explained
      below.
    </p>
    ...
    <p>
      ...
      <RouteLink to="/guide/advanced.html#collections">collections</RouteLink>. The provided
      callback function receives a
      <RouteLink to="/guide/data.html#log-data">log data object</RouteLink> for each log in the
      collection. If a truthy value is returned the current log of the iteration will be added into
      a new collection. If a falsy value is returned it will be omitted.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/guide/examples/filterCollection-example.png"
        alt="filter collection example output"
      />
    </p>
    <p>
      <img
        src="@source/guide/examples/filterCollection-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/guide/advanced.html#collections">collection</RouteLink> of logs by
      the given <RouteLink to="/guide/modifiers.html#label">label</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/guide/examples/filterLabel-example.png" alt="filter label example output" />
    </p>
    <p>
      <img
        src="@source/guide/examples/filterLabel-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/guide/advanced.html#collections">collection</RouteLink> of logs by
      the given <RouteLink to="/guide/data.html#level-filter">level filter</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/guide/examples/filterLevel-example.png" alt="filter level example output" />
    </p>
    <p>
      <img
        src="@source/guide/examples/filterLevel-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/guide/advanced.html#collections">collection</RouteLink> of logs by
      the given <RouteLink to="/guide/modifiers.html#namespace-ns">namespace</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/guide/examples/filterNamespace-example.png"
        alt="filter namespace example output"
      />
    </p>
    <p>
      <img
        src="@source/guide/examples/filterNamespace-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/guide/data.html#log-data">final log data</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/guide/adze-concepts.html#log-render">log render</RouteLink> and prints it to
...
<span class="line"></span></code></pre>
    ...
    <p><img src="@source/guide/examples/render-example.png" alt="render example output" /></p>
    <p>
      <img
        src="@source/guide/examples/render-terminal-example.png"
...
<span class="line"></span></code></pre>
    ...
    <p><img src="@source/guide/examples/rerender-example.png" alt="re-render example output" /></p>
    <p>
      <img
        src="@source/guide/examples/rerender-terminal-example.png"
