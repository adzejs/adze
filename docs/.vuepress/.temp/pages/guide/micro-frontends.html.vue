<template>
  <div>
    ...
    <p>
      This is where <RouteLink to="/guide/adze-concepts.html">Adze</RouteLink> and
      <RouteLink to="/guide/globalstore-concepts.html">GlobalStore</RouteLink> come in to help.
    ...
    <p>
      <img
        src="@source/guide/assets/micro-frontends-diagram.svg"
    ...
    <p>
      ...
      <RouteLink to="/guide/modifiers.html#namespace-ns">namespace</RouteLink> across all of them.
      This enables the parent application to target those logs and control them as needed.
    </p>
  </div>
</template>
