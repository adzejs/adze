<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/advanced.html#collections">Collection</RouteLink> of logs that
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/advanced.html#collections">collections</RouteLink>. The
      provided callback function receives a
      <RouteLink to="/.vuepress/guide/data.html#log-data">log data object</RouteLink> for each log
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterCollection-example.png"
        alt="filter collection example output"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterCollection-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/.vuepress/guide/advanced.html#collections">collection</RouteLink> of
      logs by the given <RouteLink to="/.vuepress/guide/modifiers.html#label">label</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterLabel-example.png"
        alt="filter label example output"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterLabel-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/.vuepress/guide/advanced.html#collections">collection</RouteLink> of
      logs by the given
      <RouteLink to="/.vuepress/guide/data.html#level-filter">level filter</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterLevel-example.png"
        alt="filter level example output"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterLevel-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/.vuepress/guide/advanced.html#collections">collection</RouteLink> of
      logs by the given
      <RouteLink to="/.vuepress/guide/modifiers.html#namespace-ns">namespace</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterNamespace-example.png"
        alt="filter namespace example output"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/filterNamespace-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/data.html#log-data">final log data</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/adze-concepts.html#log-render">log render</RouteLink> and
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/.vuepress/guide/examples/render-example.png" alt="render example output" />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/render-terminal-example.png"
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/rerender-example.png"
        alt="re-render example output"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/rerender-terminal-example.png"
