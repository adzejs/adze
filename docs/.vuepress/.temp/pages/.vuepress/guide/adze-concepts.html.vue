<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/modifiers.html">modifiers</RouteLink> which can be terminated
    ...
    <p>
      ...
      library only offers
      <RouteLink to="/.vuepress/guide/globalstore-concepts.html#listeners">listeners</RouteLink> as
    ...
    <p>
      <img
        src="@source/.vuepress/guide/assets/basic-architecture.svg"
    ...
    <ul>
      <li>
        <RouteLink to="/.vuepress/guide/factories.html">Log Factory</RouteLink>
        <ul>
          <li>This is a function that generates a log instance and returns it.</li>
        </ul>
      </li>
      <li>
        <RouteLink to="/.vuepress/guide/modifiers.html">Modifiers</RouteLink>
        <ul>
          <li>These log methods modify the instance and then return it.</li>
        </ul>
      </li>
      <li>
        <RouteLink to="/.vuepress/guide/default-terminators.html">Terminator</RouteLink>
        <ul>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/factories.html#adze"><code v-pre>adze()</code></RouteLink> out
      of the box. This function is a
      <RouteLink to="/.vuepress/guide/factories.html">factory</RouteLink> that creates a new Adze
      ...
      <RouteLink to="/.vuepress/guide/factories.html#seal">seal</RouteLink>, but we'll come back to
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/modifier-example.png"
    ...
    <p>
      ...
      with
      <RouteLink to="/.vuepress/guide/default-terminators.html#log"
        ><code v-pre>log()</code></RouteLink
      >. The log method is one of the eight
      <RouteLink to="/.vuepress/guide/default-terminators.html">default log terminators</RouteLink>.
      The library also comes with
      <RouteLink to="/.vuepress/guide/other-terminators.html">other special terminators</RouteLink>
      like <RouteLink to="/.vuepress/guide/other-terminators.html#custom">custom</RouteLink>. A log
      method is considered a terminator when it ends your log chain and returns a
      <RouteLink to="/.vuepress/guide/data.html#terminated-log-object"
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/factories.html#seal">seal factory</RouteLink>. When your
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/common-usage-example.png"
        alt="common usage example with seal"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/common-usage-terminal-example.png"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/globalstore-concepts.html">GlobalStore</RouteLink> for
      <RouteLink to="/.vuepress/guide/globalstore-concepts.html#listeners">listening</RouteLink> to
      our logs and we'll configure our adze factory with some
      <RouteLink to="/config/#filters">filters</RouteLink> that we'll
      <RouteLink to="/.vuepress/guide/modifiers.html#seal">seal</RouteLink> into a new factory named
      <code v-pre>log</code>.
    </p>
    <div
      class="language-javascript line-numbers-mode"
