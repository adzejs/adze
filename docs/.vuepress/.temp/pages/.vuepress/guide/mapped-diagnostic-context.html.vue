<template>
  <div>
    ...
    <p>
      ...
      as <RouteLink to="/.vuepress/guide/globalstore-concepts.html">GlobalStore</RouteLink>,
      <RouteLink to="/.vuepress/guide/modifiers.html#label">label</RouteLink>, and
      <RouteLink to="/.vuepress/guide/other-terminators.html#thread">thread</RouteLink>. We can also
      print our context using
      <RouteLink to="/.vuepress/guide/modifiers.html#dump">dump</RouteLink> or clear our context
      using <RouteLink to="/.vuepress/guide/modifiers.html#close">close</RouteLink>.
    </p>
