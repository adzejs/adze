<template>
  <div>
    ...
    <p>
      This is where <RouteLink to="/.vuepress/guide/adze-concepts.html">Adze</RouteLink> and
      <RouteLink to="/.vuepress/guide/globalstore-concepts.html">GlobalStore</RouteLink> come in to
    ...
    <p>
      <img
        src="@source/.vuepress/guide/assets/micro-frontends-diagram.svg"
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/modifiers.html#namespace-ns">namespace</RouteLink> across all
