<template>
  <div>
    <h1 id="factories" tabindex="-1">
      <a class="header-anchor" href="#factories"><span>Factories</span></a>
    </h1>
    <p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/.vuepress/guide/examples/seal-example.png" alt="Output of our sealed log" />
    </p>
  </div>
</template>
