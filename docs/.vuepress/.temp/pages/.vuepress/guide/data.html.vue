<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/factories.html#bundle">bundle</RouteLink> factory. These log
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/filtering-and-utility-functions.html#filternamespace"
        >filterNamespace</RouteLink
      >,
      <RouteLink to="/.vuepress/guide/filtering-and-utility-functions.html#filterlabel"
        >filterLabel</RouteLink
      >,
      <RouteLink to="/.vuepress/guide/filtering-and-utility-functions.html#filterlevel"
        >filterLevel</RouteLink
      >, and
      <RouteLink to="/.vuepress/guide/filtering-and-utility-functions.html#filtercollection"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      globally tracked <RouteLink to="/.vuepress/guide/modifiers.html#count">counters</RouteLink>,
      <RouteLink to="/.vuepress/guide/modifiers.html#time">timers</RouteLink>, and
      <RouteLink to="/.vuepress/guide/other-terminators.html#thread">MDC context</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/using-globalstore.html#addlistener">addListener</RouteLink>,
      <RouteLink to="/.vuepress/guide/filtering-and-utility-functions.html#filterlevel"
        >filterLevel</RouteLink
      >, or within the
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/log-render-example.png"
        alt="log render example output"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/log-render-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/using-globalstore.html#addlistener">log listener</RouteLink>
      on a <RouteLink to="/.vuepress/guide/globalstore-concepts.html">GlobalStore</RouteLink> is
      fired, the callback function will be invoked with two parameters; the
      <strong>log data object</strong> and a
      <RouteLink to="/.vuepress/guide/adze-concepts.html#logrender">log render</RouteLink>.
    </p>
    <p>
      A log data object can be manually retrieved from a log instance using the
      <RouteLink to="/.vuepress/guide/getters-and-setters.html#data">data getter</RouteLink>.
    </p>
    <p>
      A log data object can also be used to create a clone of a log by
      <RouteLink to="/.vuepress/guide/getters-and-setters.html#hydrate">hydrating</RouteLink> a new
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><RouteLink to="/.vuepress/guide/modifiers.html#assert">assert</RouteLink></td>
        </tr>
        <tr>
          <td>cfg</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/.vuepress/guide/mapped-diagnostic-context.html">MDC</RouteLink></td>
        </tr>
        <tr>
          <td>definition</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/.vuepress/guide/modifiers.html#test">test</RouteLink></td>
        </tr>
        <tr>
          <td>isSilent</td>
          <td>Boolean value indicating if the log should execute silently.</td>
          <td><RouteLink to="/.vuepress/guide/modifiers.html#silent">silent</RouteLink></td>
        </tr>
        <tr>
          <td>printed</td>
          <td>
        ...
        <tr>
          ...
          <td><RouteLink to="/.vuepress/guide/modifiers.html#timestamp">timestamp</RouteLink></td>
        </tr>
        <tr>
          <td>label</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/.vuepress/guide/modifiers.html#meta">meta</RouteLink></td>
        </tr>
        <tr>
          <td>modifierQueue</td>
          <td>
        ...
        <tr>
          ...
          <td>
            <RouteLink to="/.vuepress/guide/modifiers.html#namespace-ns">namespace / ns</RouteLink>
          </td>
        </tr>
        <tr>
          <td>stacktrace</td>
        ...
        <tr>
          ...
          <td><RouteLink to="/.vuepress/guide/modifiers.html#timenow">timeNow</RouteLink></td>
        </tr>
        <tr>
          <td>timestamp</td>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/.vuepress/guide/examples/log-data-example.png"
        alt="log data example output"
      />
    </p>
    <p>
      <img
        src="@source/.vuepress/guide/examples/log-data-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/filtering-and-utility-functions.html#render"
        >render</RouteLink
      >
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/filtering-and-utility-functions.html#render">render</RouteLink
      >.
    </p>
    <div
      class="language-javascript line-numbers-mode"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/other-terminators.html#clear-clr">clear</RouteLink>). A
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/factories.html#bundle">bundled</RouteLink>.
    </p>
    <blockquote>
