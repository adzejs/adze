<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/globalstore-concepts.html#listeners">log listeners</RouteLink
      >, there is opportunity for add-on packages to provide simple solutions for handling log data
      transports and various other solutions.
    </p>
    ...
    <p>
      ...
      <RouteLink to="/.vuepress/guide/globalstore-concepts.html#listeners">log listener</RouteLink>.
      By wrapping a log listener you can intercept the
      <RouteLink to="/.vuepress/guide/data.html#label-data-object">log data</RouteLink> and
      <RouteLink to="/.vuepress/guide/data.html#log-render">log render</RouteLink> and act upon it.
      To do this, your add-on should export a function that takes a callback function as a parameter
      and then executes that callback function at a later time and forwards the
