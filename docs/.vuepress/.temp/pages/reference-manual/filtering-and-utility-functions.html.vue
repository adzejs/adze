<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/advanced.html#collections">Collection</RouteLink> of logs
      that you would like to filter down to a specific subset. Adze provides you with some filtering
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/advanced.html#collections">collections</RouteLink>. The
      provided callback function receives a
      <RouteLink to="/reference-manual/data.html#log-data">log data object</RouteLink> for each log
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference-manual/examples/filterCollection-example.png"
        alt="filter collection example output"
      />
    </p>
    <p>
      <img
        src="@source/reference-manual/examples/filterCollection-terminal-example.png"
    ...
    <p>
      Filters a
      <RouteLink to="/reference-manual/advanced.html#collections">collection</RouteLink> of logs by
      the given <RouteLink to="/reference-manual/modifiers.html#label">label</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference-manual/examples/filterLabel-example.png"
        alt="filter label example output"
      />
    </p>
    <p>
      <img
        src="@source/reference-manual/examples/filterLabel-terminal-example.png"
    ...
    <p>
      Filters a
      <RouteLink to="/reference-manual/advanced.html#collections">collection</RouteLink> of logs by
      the given <RouteLink to="/reference-manual/data.html#level-filter">level filter</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference-manual/examples/filterLevel-example.png"
        alt="filter level example output"
      />
    </p>
    <p>
      <img
        src="@source/reference-manual/examples/filterLevel-terminal-example.png"
    ...
    <p>
      Filters a
      <RouteLink to="/reference-manual/advanced.html#collections">collection</RouteLink> of logs by
      the given <RouteLink to="/reference-manual/modifiers.html#namespace-ns">namespace</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference-manual/examples/filterNamespace-example.png"
        alt="filter namespace example output"
      />
    </p>
    <p>
      <img
        src="@source/reference-manual/examples/filterNamespace-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/data.html#log-data">final log data</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/adze-concepts.html#log-render">log render</RouteLink> and
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/reference-manual/examples/render-example.png" alt="render example output" />
    </p>
    <p>
      <img
        src="@source/reference-manual/examples/render-terminal-example.png"
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference-manual/examples/rerender-example.png"
        alt="re-render example output"
      />
    </p>
    <p>
      <img
        src="@source/reference-manual/examples/rerender-terminal-example.png"
