<template>
  <div>
    ...
    <p>
      ...
      as <RouteLink to="/reference-manual/globalstore-concepts.html">GlobalStore</RouteLink>,
      <RouteLink to="/reference-manual/modifiers.html#label">label</RouteLink>, and
      <RouteLink to="/reference-manual/other-terminators.html#thread">thread</RouteLink>. We can
      also print our context using
      <RouteLink to="/reference-manual/modifiers.html#dump">dump</RouteLink> or clear our context
      using <RouteLink to="/reference-manual/modifiers.html#close">close</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/reference-manual/examples/close-example.png" alt="close example output" />
    </p>
    <p>
      <img
        src="@source/reference-manual/examples/close-terminal-example.png"
