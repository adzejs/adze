<template>
  <div>
    ...
    <p>
      This is where <RouteLink to="/reference-manual/adze-concepts.html">Adze</RouteLink> and
      <RouteLink to="/reference-manual/globalstore-concepts.html">GlobalStore</RouteLink> come in to
    ...
    <p>
      <img
        src="@source/reference-manual/assets/micro-frontends-diagram.svg"
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/modifiers.html#namespace-ns">namespace</RouteLink> across all
