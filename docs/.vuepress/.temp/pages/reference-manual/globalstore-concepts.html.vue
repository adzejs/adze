<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/adze-concepts.html#lifecycle">Lifecycle Diagram</RouteLink>.
    </p>
    <p>
      GlobalStore is also a dependency to take advantage of some log features such as
      <RouteLink to="/reference-manual/modifiers.html#label">labels</RouteLink>,
      <RouteLink to="/reference-manual/modifiers.html#count">counters</RouteLink>, and
      <RouteLink to="/reference-manual/modifiers.html#time">timers</RouteLink>. Without the presence
    ...
    <p>
      <img
        src="@source/reference-manual/assets/large-project.svg"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/data.html#log-data">log data object</RouteLink> and the
      <RouteLink to="/reference-manual/data.html#log-render">log render</RouteLink>. With these data
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference-manual/data.html#collection">collection</RouteLink> of logs.
    </p>
    <p>
