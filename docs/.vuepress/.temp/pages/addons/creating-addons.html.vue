<template><div><h1 id="creating-add-on-s" tabindex="-1"><a class="header-anchor" href="#creating-add-on-s"><span>Creating Add-on's</span></a></h1>
<p>One of the core tenets of Adze is to <strong>not do too much</strong>. This means that the core functionality of Adze is to provide the user with the ability to have control over their logs, how they are shaped, and to be able to listen to their logs and do with the log data as they please. Anything resembling transporting log data to files, API's, or databases is purposefully omitted from the core. However, because of Adze <RouteLink to="/guide/globalstore-concepts.html#listeners">log listeners</RouteLink>, there is opportunity for add-on packages to provide simple solutions for handling log data transports and various other solutions.</p>
<h2 id="best-practices" tabindex="-1"><a class="header-anchor" href="#best-practices"><span>Best Practices</span></a></h2>
<p>When creating add-on's for Adze your primary interface should be wrapping a <RouteLink to="/guide/globalstore-concepts.html#listeners">log listener</RouteLink>. By wrapping a log listener you can intercept the <RouteLink to="/guide/data.html#label-data-object">log data</RouteLink> and <RouteLink to="/guide/data.html#log-render">log render</RouteLink> and act upon it. To do this, your add-on should export a function that takes a callback function as a parameter and then executes that callback function at a later time and forwards the <strong>log data</strong> and <strong>log render</strong> to it as parameters. Let's take a look at an example.</p>
<h2 id="add-on-example" tabindex="-1"><a class="header-anchor" href="#add-on-example"><span>Add-on Example</span></a></h2>
<p>Let's first create our wrapper function that our add-on will expose.</p>
<h4 id="my-addon-js" tabindex="-1"><a class="header-anchor" href="#my-addon-js"><span>my-addon.js</span></a></h4>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token comment">// We'll create an exported function that takes a callback as a parameter</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="my-app-js" tabindex="-1"><a class="header-anchor" href="#my-app-js"><span>my-app.js</span></a></h4>
