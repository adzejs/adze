<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/reference/advanced.html#collections">Collection</RouteLink> of logs that you
      would like to filter down to a specific subset. Adze provides you with some filtering
    ...
    <p>
      ...
      <RouteLink to="/reference/advanced.html#collections">collections</RouteLink>. The provided
      callback function receives a
      <RouteLink to="/reference/data.html#log-data">log data object</RouteLink> for each log in the
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference/examples/filterCollection-example.png"
        alt="filter collection example output"
      />
    </p>
    <p>
      <img
        src="@source/reference/examples/filterCollection-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/reference/advanced.html#collections">collection</RouteLink> of logs
      by the given <RouteLink to="/reference/modifiers.html#label">label</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference/examples/filterLabel-example.png"
        alt="filter label example output"
      />
    </p>
    <p>
      <img
        src="@source/reference/examples/filterLabel-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/reference/advanced.html#collections">collection</RouteLink> of logs
      by the given <RouteLink to="/reference/data.html#level-filter">level filter</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference/examples/filterLevel-example.png"
        alt="filter level example output"
      />
    </p>
    <p>
      <img
        src="@source/reference/examples/filterLevel-terminal-example.png"
    ...
    <p>
      Filters a <RouteLink to="/reference/advanced.html#collections">collection</RouteLink> of logs
      by the given <RouteLink to="/reference/modifiers.html#namespace-ns">namespace</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference/examples/filterNamespace-example.png"
        alt="filter namespace example output"
      />
    </p>
    <p>
      <img
        src="@source/reference/examples/filterNamespace-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/reference/data.html#log-data">final log data</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference/adze-concepts.html#log-render">log render</RouteLink> and prints it
...
<span class="line"></span></code></pre>
    ...
    <p><img src="@source/reference/examples/render-example.png" alt="render example output" /></p>
    <p>
      <img
        src="@source/reference/examples/render-terminal-example.png"
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/reference/examples/rerender-example.png" alt="re-render example output" />
    </p>
    <p>
      <img
        src="@source/reference/examples/rerender-terminal-example.png"
