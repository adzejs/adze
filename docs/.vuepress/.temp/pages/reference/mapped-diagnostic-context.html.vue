<template>
  <div>
    ...
    <p>
      ...
      as <RouteLink to="/reference/globalstore-concepts.html">GlobalStore</RouteLink>,
      <RouteLink to="/reference/modifiers.html#label">label</RouteLink>, and
      <RouteLink to="/reference/other-terminators.html#thread">thread</RouteLink>. We can also print
      our context using <RouteLink to="/reference/modifiers.html#dump">dump</RouteLink> or clear our
      context using <RouteLink to="/reference/modifiers.html#close">close</RouteLink>.
    </p>
