<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/reference/factories.html#bundle">bundle</RouteLink> factory. These log
    ...
    <p>
      ...
      <RouteLink to="/reference/filtering-and-utility-functions.html#filternamespace"
        >filterNamespace</RouteLink
      >,
      <RouteLink to="/reference/filtering-and-utility-functions.html#filterlabel"
        >filterLabel</RouteLink
      >,
      <RouteLink to="/reference/filtering-and-utility-functions.html#filterlevel"
        >filterLevel</RouteLink
      >, and
      <RouteLink to="/reference/filtering-and-utility-functions.html#filtercollection"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      globally tracked <RouteLink to="/reference/modifiers.html#count">counters</RouteLink>,
      <RouteLink to="/reference/modifiers.html#time">timers</RouteLink>, and
      <RouteLink to="/reference/other-terminators.html#thread">MDC context</RouteLink>.
    </p>
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference/using-globalstore.html#addlistener">addListener</RouteLink>,
      <RouteLink to="/reference/filtering-and-utility-functions.html#filterlevel"
        >filterLevel</RouteLink
      >, or within the
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img
        src="@source/reference/examples/log-render-example.png"
        alt="log render example output"
      />
    </p>
    <p>
      <img
        src="@source/reference/examples/log-render-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/reference/using-globalstore.html#addlistener">log listener</RouteLink> on a
      <RouteLink to="/reference/globalstore-concepts.html">GlobalStore</RouteLink> is fired, the
      callback function will be invoked with two parameters; the
      <strong>log data object</strong> and a
      <RouteLink to="/reference/adze-concepts.html#logrender">log render</RouteLink>.
    </p>
    <p>
      A log data object can be manually retrieved from a log instance using the
      <RouteLink to="/reference/getters-and-setters.html#data">data getter</RouteLink>.
    </p>
    <p>
      A log data object can also be used to create a clone of a log by
      <RouteLink to="/reference/getters-and-setters.html#hydrate">hydrating</RouteLink> a new log
...
<span class="line"></span></code></pre>
    ...
    <p>
      <img src="@source/reference/examples/log-data-example.png" alt="log data example output" />
    </p>
    <p>
      <img
        src="@source/reference/examples/log-data-terminal-example.png"
    ...
    <p>
      ...
      <RouteLink to="/reference/filtering-and-utility-functions.html#rerender">re-render</RouteLink>
      your log exactly how the Adze log instance rendered it. Here is an example of how
      <RouteLink to="/reference/filtering-and-utility-functions.html#render">render</RouteLink> a
      log using a log render:
    </p>
    ...
    <p>
      ...
      <RouteLink to="/reference/filtering-and-utility-functions.html#render">render</RouteLink>.
    </p>
    <div
      class="language-javascript line-numbers-mode"
      data-highlighter="prismjs"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference/other-terminators.html#clear-clr">clear</RouteLink>). A terminated
      log object consists of three parts, the <strong>Log Instance</strong>, the
    ...
    <p>
      ...
      <RouteLink to="/reference/factories.html#bundle">bundled</RouteLink>.
    </p>
    <blockquote>
