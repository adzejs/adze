...
<p>In this section of the guide we'll take a look at some of the important data structures that exist across the Adze API.</p>
<h2 id="collections" tabindex="-1"><a class="header-anchor" href="#collections"><span>Collections</span></a></h2>
<p>A Collection is simply an array of Adze log instances that extend from the <strong>BaseLog</strong> class. There are two types of instances that extend BaseLog, <strong>BundledLog</strong> and <strong>Log</strong>. You will never interact with a <strong>BaseLog</strong> instance directly.</p>
<p>A <strong>Log</strong> is the instance type that is created whenever you normally terminate a log.</p>
<p>A <strong>BundledLog</strong> is a log instance that is generated from a <RouteLink to="/reference/factories.html#bundle">bundle</RouteLink> factory. These log instances have a getter that allows you to access the log bundle.</p>
<p>Collections are typically used in conjunction with filter functions like <RouteLink to="/reference/filtering-and-utility-functions.html#filternamespace">filterNamespace</RouteLink>, <RouteLink to="/reference/filtering-and-utility-functions.html#filterlabel">filterLabel</RouteLink>, <RouteLink to="/reference/filtering-and-utility-functions.html#filterlevel">filterLevel</RouteLink>, and <RouteLink to="/reference/filtering-and-utility-functions.html#filtercollection">filterCollection</RouteLink>.</p>
<h3 id="interface" tabindex="-1"><a class="header-anchor" href="#interface"><span>Interface</span></a></h3>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">type</span> <span class="token class-name">Collection</span> <span class="token operator">=</span> BaseLog<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="bundle-example" tabindex="-1"><a class="header-anchor" href="#bundle-example"><span>Bundle Example</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> adze<span class="token punctuation">,</span> createGlobalStore <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'adze'</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="globalstore-example" tabindex="-1"><a class="header-anchor" href="#globalstore-example"><span>GlobalStore Example</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> adze<span class="token punctuation">,</span> createGlobalStore <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'adze'</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="label-data-object" tabindex="-1"><a class="header-anchor" href="#label-data-object"><span>Label Data Object</span></a></h2>
<p>A label data object is generated from a label instance. This object contains data that from globally tracked <RouteLink to="/reference/modifiers.html#count">counters</RouteLink>, <RouteLink to="/reference/modifiers.html#time">timers</RouteLink>, and <RouteLink to="/reference/other-terminators.html#thread">MDC context</RouteLink>.</p>
<h3 id="interface-1" tabindex="-1"><a class="header-anchor" href="#interface-1"><span>Interface</span></a></h3>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">interface</span> <span class="token class-name">LabelData</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="level-filter" tabindex="-1"><a class="header-anchor" href="#level-filter"><span>Level Filter</span></a></h2>
<p>A level filter type is a value that represents one or more log levels. Level Filters are used with any method that allows you to specify a target log level like <RouteLink to="/reference/using-globalstore.html#addlistener">addListener</RouteLink>, <RouteLink to="/reference/filtering-and-utility-functions.html#filterlevel">filterLevel</RouteLink>, or within the <RouteLink to="/config/#filters">filter configurations on Adze logs</RouteLink>.</p>
<table>
<thead>
<tr>
<th>Value</th>
...
<p><img src="@source/reference/examples/log-render-example.png" alt="log render example output"></p>
<p><img src="@source/reference/examples/log-render-terminal-example.png" alt="log render example terminal output"></p>
<h2 id="log-data" tabindex="-1"><a class="header-anchor" href="#log-data"><span>Log Data</span></a></h2>
<p>The log data object contains all of the important meta data from a log's instance. The log data object is used throughout the Adze API. For example, when a <RouteLink to="/reference/using-globalstore.html#addlistener">log listener</RouteLink> on a <RouteLink to="/reference/globalstore-concepts.html">GlobalStore</RouteLink> is fired, the callback function will be invoked with two parameters; the <strong>log data object</strong> and a <RouteLink to="/reference/adze-concepts.html#logrender">log render</RouteLink>.</p>
<p>A log data object can be manually retrieved from a log instance using the <RouteLink to="/reference/getters-and-setters.html#data">data getter</RouteLink>.</p>
<p>A log data object can also be used to create a clone of a log by <RouteLink to="/reference/getters-and-setters.html#hydrate">hydrating</RouteLink> a new log instance from the log data object.</p>
<p>Final log data extends log data and changes the possible values of some properties. Certain methods require final log data to be provided to it. Use the <RouteLink to="/reference/filtering-and-utility-functions.html#isfinallogdata">isFinalLogData</RouteLink> type guard to verify it.</p>
<blockquote>
...
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token comment">// The log data object's interface</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="property-descriptions" tabindex="-1"><a class="header-anchor" href="#property-descriptions"><span>Property Descriptions</span></a></h3>
<table>
<thead>
<tr>
<th>Name</th>
...
<td><RouteLink to="/reference/modifiers.html#assert">assert</RouteLink></td>
</tr>
<tr>
<td>cfg</td>
...
<td><RouteLink to="/reference/mapped-diagnostic-context.html">MDC</RouteLink></td>
</tr>
<tr>
<td>definition</td>
<td>Configuration of the log level of the instance.</td>
<td><RouteLink to="/config/#log-levels-log-level-definition">Log Level Definition</RouteLink></td>
</tr>
<tr>
<td>dumpContext</td>
...
<td><RouteLink to="/reference/modifiers.html#test">test</RouteLink></td>
</tr>
<tr>
<td>isSilent</td>
<td>Boolean value indicating if the log should execute silently.</td>
<td><RouteLink to="/reference/modifiers.html#silent">silent</RouteLink></td>
</tr>
<tr>
<td>printed</td>
<td>Boolean value indicating if the log has been printed to the console (versions &gt;= 1.3.0).</td>
...
<td><RouteLink to="/reference/modifiers.html#timestamp">timestamp</RouteLink></td>
</tr>
<tr>
<td>label</td>
...
<td><RouteLink to="/reference/modifiers.html#meta">meta</RouteLink></td>
</tr>
<tr>
<td>modifierQueue</td>
<td>The queue of modifiers that will be executed against the log instance when it is terminated.</td>
<td>-</td>
</tr>
<tr>
<td>namespace</td>
<td>Array of namespaces associate to the log instance.</td>
<td><RouteLink to="/reference/modifiers.html#namespace-ns">namespace / ns</RouteLink></td>
</tr>
<tr>
<td>stacktrace</td>
...
<td><RouteLink to="/reference/modifiers.html#timenow">timeNow</RouteLink></td>
</tr>
<tr>
<td>timestamp</td>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="output-1" tabindex="-1"><a class="header-anchor" href="#output-1"><span>Output</span></a></h3>
<p><img src="@source/reference/examples/log-data-example.png" alt="log data example output"></p>
<p><img src="@source/reference/examples/log-data-terminal-example.png" alt="log data example terminal output"></p>
<h2 id="log-render" tabindex="-1"><a class="header-anchor" href="#log-render"><span>Log Render</span></a></h2>
<p>A log render is returned as a sub-property of a <a href="#terminated-log-object">terminated log object</a>. The log render is a tuple in the form of <code v-pre>[method, args]</code> that you can use to <RouteLink to="/reference/filtering-and-utility-functions.html#rerender">re-render</RouteLink> your log exactly how the Adze log instance rendered it. Here is an example of how <RouteLink to="/reference/filtering-and-utility-functions.html#render">render</RouteLink> a log using a log render:</p>
<h3 id="manual-example" tabindex="-1"><a class="header-anchor" href="#manual-example"><span>Manual Example</span></a></h3>
<p><em>NOTE:</em> This is not the recommended way of doing this. Please refer to <RouteLink to="/reference/filtering-and-utility-functions.html#render">render</RouteLink>.</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> adze <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'adze'</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="output-2" tabindex="-1"><a class="header-anchor" href="#output-2"><span>Output</span></a></h3>
<p><img src="@source/reference/examples/log-render-example.png" alt="log render example output"></p>
<p><img src="@source/reference/examples/log-render-terminal-example.png" alt="log render example terminal output"></p>
<h2 id="log-timestamp" tabindex="-1"><a class="header-anchor" href="#log-timestamp"><span>Log Timestamp</span></a></h2>
<p>The log timestamp data object contains timestamp values in multiple formats from when the log instance was terminated.</p>
<blockquote>
...
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token keyword">interface</span> <span class="token class-name">LogTimestamp</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="example-2" tabindex="-1"><a class="header-anchor" href="#example-2"><span>Example</span></a></h3>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> adze<span class="token punctuation">,</span> createGlobalStore <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'adze'</span><span class="token punctuation">;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="terminated-log-object" tabindex="-1"><a class="header-anchor" href="#terminated-log-object"><span>Terminated Log Object</span></a></h2>
<p>After an Adze log has been terminated a <strong>Terminated Log object</strong> will be returned (with a couple of exceptions, like <RouteLink to="/reference/other-terminators.html#clear-clr">clear</RouteLink>). A terminated log object consists of three parts, the <strong>Log Instance</strong>, the <a href="#log-render">Log Render</a>, and the <strong>printed</strong> value that indicates if the log was printed to the console.</p>
<p>The log instance is the reference to the instance that was terminated. You can use this to get <a href="#log-data">meta data about the Log</a> or get a <a href="#collection">collection</a> of logs if the log was <RouteLink to="/reference/factories.html#bundle">bundled</RouteLink>.</p>
<blockquote>
<p><code v-pre>printed</code> property supported in versions &gt;= 1.3.0</p>
</blockquote>
<h3 id="interface-4" tabindex="-1"><a class="header-anchor" href="#interface-4"><span>Interface</span></a></h3>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token comment">// Versions &lt; 1.3.0</span></span>
