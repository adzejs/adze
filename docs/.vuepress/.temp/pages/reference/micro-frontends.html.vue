<template>
  <div>
    ...
    <p>
      This is where <RouteLink to="/reference/adze-concepts.html">Adze</RouteLink> and
      <RouteLink to="/reference/globalstore-concepts.html">GlobalStore</RouteLink> come in to help.
      Because a GlobalStore is a global cache and configuration store, it takes precedence over the
      configuration of any Adze logs. What this means for a micro-frontend architecture is that you
      can keep your logs for production and the parent application can control their behavior
      without knowing anything about the child application.
    </p>
    ...
    <p>
      <img
        src="@source/reference/assets/micro-frontends-diagram.svg"
    ...
    <p>
      ...
      <RouteLink to="/reference/modifiers.html#namespace-ns">namespace</RouteLink> across all of
      them. This enables the parent application to target those logs and control them as needed.
    </p>
  </div>
</template>
