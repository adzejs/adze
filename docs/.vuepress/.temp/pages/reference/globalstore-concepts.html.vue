<template>
  <div>
    ...
    <p>
      ...
      <RouteLink to="/reference/adze-concepts.html#lifecycle">Lifecycle Diagram</RouteLink>.
    </p>
    <p>
      GlobalStore is also a dependency to take advantage of some log features such as
      <RouteLink to="/reference/modifiers.html#label">labels</RouteLink>,
      <RouteLink to="/reference/modifiers.html#count">counters</RouteLink>, and
      <RouteLink to="/reference/modifiers.html#time">timers</RouteLink>. Without the presence of a
    ...
    <p>
      <img
        src="@source/reference/assets/large-project.svg"
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference/data.html#log-data">log data object</RouteLink> and the
      <RouteLink to="/reference/data.html#log-render">log render</RouteLink>. With these data
...
<span class="line"></span></code></pre>
    ...
    <p>
      ...
      <RouteLink to="/reference/filtering-and-utility-functions.html">filter functions</RouteLink>
      out of the box and that you can use to operate on a
      <RouteLink to="/reference/data.html#collection">collection</RouteLink> of logs.
    </p>
    <p>
