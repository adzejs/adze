...
describe('terminators with json format', () => {
  afterEach(() => {
    teardown();
  });

  test('prints a json log with level of alert', async () => {
    const fn = vi.fn();
    console.error = fn;
  ...
  test('prints a json log with level of error', () => {
    const fn = vi.fn();
    console.error = fn;
    setup({ format: 'json', timestampFormatter: () => '2024-07-31T13:19:25-04:00' });
  ...
  test('prints a json log with level of warn', () => {
    const fn = vi.fn();
    console.warn = fn;
    setup({ format: 'json', timestampFormatter: () => '2024-07-31T13:19:25-04:00' });
  ...
  test('prints a json log with level of info', () => {
    const fn = vi.fn();
    console.info = fn;
    setup({ format: 'json', timestampFormatter: () => '2024-07-31T13:19:25-04:00' });
  ...
  test('prints a json log with level of fail', () => {
    const fn = vi.fn();
    console.info = fn;
    setup({ format: 'json', timestampFormatter: () => '2024-07-31T13:19:25-04:00' });
  ...
  test('prints a json log with level of success', () => {
    const fn = vi.fn();
    console.info = fn;
    setup({ format: 'json', timestampFormatter: () => '2024-07-31T13:19:25-04:00' });
  ...
  test('prints a json log with level of log', () => {
    const fn = vi.fn();
    console.log = fn;
    setup({ format: 'json', timestampFormatter: () => '2024-07-31T13:19:25-04:00' });
  ...
  test('prints a json log with level of debug', () => {
    const fn = vi.fn();
    console.debug = fn;
    setup({
      activeLevel: 'debug',
  ...
  test('prints a json log with level of verbose', () => {
    const fn = vi.fn();
    console.debug = fn;
    setup({
      activeLevel: 'verbose',
  ...
  test('default timestamp matches ISO-8601 format', () => {
    const fn = vi.fn();
    console.log = fn;
    setup({
      format: 'json',
  ...
  test('multiple json logs have incrementing pids', () => {
    const fn = vi.fn();
    console.log = fn;
    setup({
      format: 'json',
  ...
  test('prints an alert json log with all of the optional fields', async () => {
    const fn = vi.fn();
    console.error = fn;
    setup({ format: 'json', timestampFormatter: () => '2024-07-31T13:19:25-04:00' });
