// import { adze, createStore, Shed } from './src';
...
// // TODO: Convert Adze custom function generators into mixins

// interface Adze {
//   doSomething(): void;
// };

// interface CustomAdze {
//   doNothing(): void;
// }
...
// interface Adze extends CustomAdze {}
...
adze.info("dfadfadf");
adze.ns("dfadf").custom('andrew', 1234, 'dfadfadf');
adze.ns("dfadf").custom('doobadoo', 1234, 'dfadfadf');